...
\acs{svm}s are widely used in pattern recognition and classification tasks \cite{MLSVMAP:1,MLSVMAP:2,MLSVMAP:3,MLSVMAP:4,MLSVMAP:5} and nonlinear regressions \cite{MLSVMAP:6,MLSVMAP:7}
\begin{figure}[ht]
